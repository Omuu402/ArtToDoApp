...
import com.patelomkumar.arttodoapp.databinding.FragmentFinishedBinding
...
class FinishedFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.fabAddTask.setOnClickListener {
            AddEditTaskDialog.newInstance(defaultStatus = "FINISHED")
    ...
    private fun observeTasks() {
        viewModel.finishedTasks.observe(viewLifecycleOwner) { tasks ->
